...
# File paths
input_file_path = 'C:/Users/PAVILION/Downloads/2201EE85_CS384_2024/tut10/Input-1 Lab 10.xlsx'
output_file_generated_path = 'Output-1.xlsx'
...
def run_app():
    ...
    target_folder = os.path.join(current_folder, "tut10")
    
    # Command to run the npm script
    command = ["node", "app.js"]

    try:
        # Run the command in the current folder
        result = subprocess.run(command, cwd=target_folder, check=True, text=True, capture_output=True)
